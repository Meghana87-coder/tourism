...
<tr>
       <td><b><font size="4" color="black"> PLACE NAME:</font></b></label></td>
       <td><input name="pname"  type="text" maxlength="10" required></td>
</tr>
<tr>
...
<tr>
     <td><label for="first"><font size="4" color="black"><b>EVENT NAME:</b></font></td>
     <td><input name="ename"  type="text" maxlength="10" required></td>
</tr>
<tr>
    <!-- <td><label for="first"><font size="4" color="black"><b>TRANSPORTATION NAME:</b></font></td>
     <td><input name="tname"  type="text" maxlength="10" required></td>
</tr>-->
   <TD align="left"><font size="4">TRANSPORTATION NAME:
...
?>
<tr>
     <td><label for="first"><font size="4" color="black"><b>ACCOMODATION NAME:</b></font></td>
     <td><input name="aname"  type="text" maxlength="10" required></td>
</tr>
...
$query="insert into booking(nname,phone,email,address,pplaceid,pname,days,ena,aname,tname,noro) 
values('$uname','$uphone','$umail','$uadd','$uplaceid','$upnamr','$days','$tename','$taname','$ttname','$nrooms')";
